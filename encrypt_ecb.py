...
# Convert into two 8-bit binary, followed by converting into hexadecimal
binary_string = H1
hex_values = [hex(int(binary_string[i:i+8], 2))[2:].zfill(2) for i in range(0, len(binary_string), 8)]
cipher_hex_1= ' '.join(hex_values)
print("cipher_hex_1= ", cipher_hex_1)
...
binary_string = H2
hex_values = [hex(int(binary_string[i:i+8], 2))[2:].zfill(2) for i in range(0, len(binary_string), 8)]
cipher_hex_2= ' '.join(hex_values)
print("cipher_hex_2= ", cipher_hex_2)
...
print("Ciphertext= ", cipher_dec_1 + " " + cipher_dec_2)